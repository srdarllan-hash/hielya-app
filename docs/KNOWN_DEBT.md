...
| Documentação do plano/requisitos permanece na linhagem separada do PR34 | Revisão documental e incorporação explicitamente aprovada; enquanto isso usar links imutáveis | [Proveniência](requirements/README.md), [v5.9](checkpoints/2026-09/HIELYA_CHECKPOINT_2026-09-07_v5.9.md) |
