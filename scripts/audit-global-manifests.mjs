...
const required = ['components.json','primitives.json','assets.json','screens.json','certifications.json','workflows.json','artifacts.json','versions.json','C-005.json','C-001.json','C-001-visual-baseline.json','C-002.json','C-002-assets.json'];
...
const result = {
  ...
  checks: {
    ...
    c002AuthorizedForImplementation: screens.screens.find((item) => item.screenId === 'C-002')?.sourceStatus === 'AUTHORIZED_FOR_IMPLEMENTATION',
